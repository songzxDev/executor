...
import cn.songzx.executor.sixth.myrejectedexecutionhandler.MySixthRejectedExecutionHandlerA;
...
public class MySixthRunA_A {
	...
	public static void main(String[] args) {
		...
		// setRejectedExecutionHandler()作用是可以处理任务被拒绝执行时的行为
		pool.setRejectedExecutionHandler(new MySixthRejectedExecutionHandlerA());
