...
public class MySecondRunE {
	...
	public static void main(String[] args) {
		/*
		 * 队列使用SynchronousQueue类，如果线程数量>corePoolSize时将其余的任务放入队列中，总是量为8，
		 * 并且线程的总数量也没有超过maximumPoolSize值的8，由于运行的线程数为8，数量上>corePoolSize为7的值，所以
		 * keepAliveTime>5时清除空闲线程，如果使用SynchronousQueue类则maximumPoolSize参数的作用将有效
		 */
